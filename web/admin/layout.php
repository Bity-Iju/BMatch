...
<div class="d-flex min-vh-100">
  <aside class="sidebar p-3 d-flex flex-column">
    <a class="brand text-white text-decoration-none mb-4" href="index.php"><span class="brand-logo"><img src="assets/logo.png" alt="BMatch logo"></span><span>BMatch<small>ADMIN</small></span></a>
